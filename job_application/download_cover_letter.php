...
// Fetch cover letter filename from db
$stmt = $pdo->prepare("
    SELECT cover_letter, name
...
$safeFileName = basename($application['cover_letter']);
$filePath = __DIR__ . '/../uploads/cover_letters/' . $safeFileName;
...
// Build a clean download name: "Cover Letter - Applicant Name.ext"
$cleanName = preg_replace('/[^a-zA-Z0-9\s\-]/', '', $application['name']);
$downloadName = 'Cover Letter - ' . $cleanName . '.' . $ext;
